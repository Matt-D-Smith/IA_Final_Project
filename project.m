...
%objects( 6).type = "wall";   objects( 6).points = [-5,  1;  8 ,  1];
...
%objects(12).type = "goal";   objects(12).points = [ -7.5, 0.8;  -7.5, 0.2];
...
robot.pos           = [0,0];    % Map units
robot.angle         = 0;        % radians
...
time = 0;
fNum = 0; % Frame Number
v = VideoWriter("ProjectRecording1","MPEG-4");
v.FrameRate = 10;
open(v);
