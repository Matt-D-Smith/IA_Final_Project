...
objects(11).type = "goal";   objects(11).points = [6.5, 0.5;  6.5, -0.1];
objects(12).type = "wall";   objects(12).points = [-2.5, 1;  -2.5, 0.1];
objects(13).type = "wall";   objects(13).points = [-2.5, 0.1;  5.5, 0.1];
objects(14).type = "wall";   objects(14).points = [5.5, 0.1;  5.5, 1];
...
robot.pos           = [-6.5,-3.5];    % Map units
robot.angle         = pi/2;        % radians
...
time = 0;
fNum = 0; % Frame Number
v = VideoWriter("ProjectRecording3","MPEG-4");
v.FrameRate = 10;
open(v);
