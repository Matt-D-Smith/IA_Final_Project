...
objects(11).type = "goal";   objects(11).points = [ 7, -2;  7.2, -2.2];
objects(12).type = "wall";   objects(12).points = [3,-1;  3,-3];
objects(13).type = "wall";   objects(13).points = [3,-3;  4,-3];
objects(14).type = "wall";   objects(14).points = [4,-3;  4,-1];
...
robot.pos           = [-1.5,4];    % Map units
robot.angle         = 3*pi/4;        % radians
...
time = 0;
fNum = 0; % Frame Number
v = VideoWriter("ProjectRecording4","MPEG-4");
v.FrameRate = 10;
open(v);
